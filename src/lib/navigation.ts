...
export const NAV_ITEMS: NavItem[] = [
  ...
  { id: "pa-by-consultant", label: "PAs by consultant",
    to: "/admin/pa-by-consultant",
    icon: Activity, group: "analytics", roles: ["admin", "rota_coordinator"],
    keywords: ["pa", "programmed activities", "consultant", "clwrota", "recorded", "evidence gap", "icu", "intensive care", "appraisal", "revalidation"] },
  ...
  { id: "tutorial-dashboard", label: "Tutorial deliveries dashboard",
    to: "/admin/tutorial-dashboard",
    icon: GraduationCap, group: "analytics", roles: ["admin", "rota_coordinator"],
    keywords: ["tutorial", "deliveries", "dashboard", "clwrota", "comparison", "count", "audit"] },
