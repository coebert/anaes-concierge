...
export const Route = createFileRoute("/_authenticated/calendar/")({
  head: () => ({
    meta: [
      { title: "Global calendar — Salisbury Anaesthetics Rota" },
      {
        name: "description",
        content:
          "Department-wide theatre, duty, on-call and weekend calendar with staff-level rota views.",
      },
      { property: "og:title", content: "Global rota calendar" },
      {
        property: "og:description",
        content:
          "See the full department rota, including theatre sessions, duties, weekends, tutorials and medical examiner sessions.",
      },
