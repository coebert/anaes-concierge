...
import { Info, Users, AlertTriangle, CheckCircle2 } from "lucide-react";
...
export function DepartmentSummaryCard({ summary }: { summary: DepartmentSummary }) {
  const linkagePct =
...
export function SlotsTable({ slots }: { slots: ListSlotFeasibility[] }) {
  if (slots.length === 0) {
    return (
      <Card>
